...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("TEAMZYRO/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("TEAMZYRO/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("TEAMZYRO/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("TEAMZYRO/assets/assets/play_icons.png")
